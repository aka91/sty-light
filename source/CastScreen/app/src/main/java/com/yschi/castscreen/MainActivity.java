...
public class MainActivity extends Activity {
    private static final String TAG = "MainActivity"; // To write to logcat
    ...
    /*
        ...
        A Service is an application component representing either an application's desire to perform
        a longer-running operation while not interacting with the user or to supply functionality for
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
            A list view is an adapter view that does not know the details,
            such as type and contents, of the views it contains.
            Instead list view requests views on demand from a ListAdapter as needed,
        ...
        /*
            ...
            The simplest adapter to use is called an ArrayAdapter because the adapter
        ...
        /*
            Instantiates a new onItemClickListener
        ...
        mReceiverTextView = (TextView) findViewById(R.id.receiver_textview);  //"Using Server mode"
        //final EditText ipEditText = findViewById(R.id.ip_edittext);//"Text field"
        //final Button selectButton = (Button) findViewById(R.id.select_button);//"Input Receiver"
        /*
            Create a new onClickListener
            Overrides the onClick function
         */
        ...
        */
        /*
            Drop down menu
         */
        // Spinner 1: Format Spinner -> default: H264
        ...
        /*
            Creates a new onItemSelected Listener
            Overrides onItemSelected function
         */
        ...
        // Spinner 2: Resolution -> default: 1280 x 720 @ 320
        ...
        // Spinner 3: bit rate -> default: 6 Mbps
    ...
    @Override
    public boolean onOptionsItemSelected(MenuItem item) { // For options in the menu (Start/Stop)
        ...
        if (id == R.id.action_start) {
            Log.d(TAG, "==== start ====");
            if (mReceiverIp != null) { //What is mReceiverIP ????
                startCaptureScreen(); //Starts capturing the screen
    ...
    private void startService() {
        if (mResultCode != 0 && mResultData != null && mReceiverIp != null) {
            ...
            Log.d(TAG, "===== Starting service 1 =====");
            /*
                A Service is an application component that can perform long-running operations in the background,
                and it does not provide a user interface. Another application component can start a service,
                and it continues to run in the background even if the user switches to another application
             */
            /*
                ...
                started it is destroyed. Usually, a started service performs a single operation and does not return a
                result to the caller. For example, it can download or upload a file over the network.
                When the operation is complete, the service should stop itself.
             */
            startService(intent);
            bindService(intent, mServiceConnection, Context.BIND_AUTO_CREATE);
            Log.d(TAG, "===== Started service 1 =====");
        } else {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                while (true) {
                    ...
                    try {
                        Log.d(TAG, "======= Receiving Package =======");
                        discoverUdpSocket.receive(receivePacket);
                        Log.d(TAG, "======= Receive Package Done =======");
