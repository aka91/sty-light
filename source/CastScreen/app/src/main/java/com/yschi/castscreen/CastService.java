...
public class CastService extends Service {
    ...
    private boolean startScreenCapture() {
        ...
        if (mResultCode != 0 && mResultData != null) {
            Log.d(TAG, "Start Capture Screen");
    ...
    private void startRecording() {
        ...
        mVirtualDisplay = mMediaProjection.createVirtualDisplay("Recording Display", mSelectedWidth,
                ...
                null /* callback */, null /* handler */); //Fatemeh: change virtual display size
    ...
    private void prepareVideoEncoder() {
        ...
        int frameRate = Common.DEFAULT_VIDEO_FPS; // Fatemeh: Maybe change this for faster response?
                        ...
                        try {
                            ...
                            if (mIvfWriter != null) {
                                ...
                                if (SDK_INT > 8) {
                                    ...
                                    Log.d(TAG, "Writing data to socket: " + b);
                                }
                                else{
                                    mSocketOutputStream.write(b);
                                }
        ...
        Thread th = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.d(TAG, "Created Server Socket on port: " + Common.VIEWER_PORT);
                    while (!Thread.currentThread().isInterrupted() && !mServerSocket.isClosed()) {
                        mSocket = mServerSocket.accept();
                        CommunicationThread commThread = new CommunicationThread(mSocket); //Client socket
                        new Thread(commThread).start(); //Starts receiving and sending data
                    }
                } catch (IOException e) {
